...
url_dat <- "https://raw.githubusercontent.com/statistikZH/covid19monitoring_social_SWISSIX/master/Social_SWISSIX.csv"
...
```{r visualisation daily, fig.height=8, fig.width=12, echo=FALSE}
...
```{r visualisation weekly, fig.height=8, fig.width=12}
